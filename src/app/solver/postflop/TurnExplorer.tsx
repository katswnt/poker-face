  ...
  return <main className={styles.page}>
    ...
    <div className={styles.shell}>
      <header className={styles.header}>
        <nav aria-label="Solver navigation" className={styles.nav}><Link href="/">← Poker Face</Link><Link href="/solver/flop">Flop to river library</Link><Link href="/solver/river">River lab</Link><Link href="/solver/lab">Leduc lab</Link><Link href="/solver">Push/fold explorer</Link><Link href="/drills">Math drills</Link></nav>
