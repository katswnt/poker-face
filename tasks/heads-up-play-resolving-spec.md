...
- Library spots use `exportScope: "first-street"`, so turn/river strategies are **not saved**.
  At each street root the AI runs a **street-root re-solve**: a spot with the actual board, pot
